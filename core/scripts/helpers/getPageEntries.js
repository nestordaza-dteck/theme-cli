                        ...
                        fs_1.default.access(pagesEntry, function (error) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 5:
                                        folderFiles = _a.sent();
                                        dataFileName = folderFiles.find(function (page) {
                                            return /([a-zA-Z_]+)\.data\.(js|ts)/i.test(page);
                                        });
                                        if (!!dataFileName) return [3 /*break*/, 7];
                                        dataFileName = folders[i] + ".data.ts";
                                        return [4 /*yield*/, fs_1.default.writeFileSync(path_1.default.join(folderDir, dataFileName), page_1.pageTemplate)];
                                    case 6:
                                        _a.sent();
                                        _a.label = 7;
                                    case 7:
                                    ...
                                    case 9:
                                        res = entries.map(function (entry) {
                                            ...
                                            // inside plugin
                                            return ["_page." + path_1.default.basename(entry), entry];
                                        });
